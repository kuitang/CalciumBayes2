...
\centering
\subfigure[Baselines]{
  \includegraphics[width=0.99\textwidth, trim=40mm 100mm 40mm 100mm, clip]{12n_noise_b}
}
\subfigure[Connectivity Weights]{
  \includegraphics[width=0.99\textwidth, trim=40mm 100mm 40mm 100mm, clip]{12n_noise_w}
}
...
\label{loglikelihood}
\centering
  \includegraphics[width=0.98\textwidth]{25n_noise_ll}
  \caption{The log likelihood increases and converges.}
\end{figure}

\subsection{Examples SMC Results}
\begin{figure}
\label{loglikelihood}
\centering
  \includegraphics[width=0.98\textwidth]{smc_figure}
